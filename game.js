...
const story = {
    ...
    "leadingreflect": {
        text: "You think back to a battle where one of your miscalulations cost you deeply.",
        choices: [
    ...
    "gatheringMatsandFinance": {
        ...
        art: "MatsandFinancegathering.jpg"
    },
    "gatheringLogAndTech": {
